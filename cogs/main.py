...
async def embed_main_help(ctx: commands.Context) -> discord.Embed:
    """Main menu embed"""
    prefix = ctx.prefix
    seasonal_event = f'{emojis.BP} `{prefix}cel` : 500k celebration guide\n'
    progress = (
    ...
    embed.add_field(name=f'500K CELEBRATION 2022 {emojis.COIN_CELEBRATION}', value=seasonal_event, inline=False)
