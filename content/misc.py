...
async def embed_badges() -> discord.Embed:
    ...
    badges_other = (
        ...
        f'{emojis.BP} {emojis.BADGE_ETERNAL} : Unlocked by unlocking the eternity\n'
...
async def embed_coolness_overview() -> discord.Embed:
    ...
    pet_slots = (
        f'{emojis.BP} x`1.15` at 11 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`1.3` at 101 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`1.45` at 351 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`1.6` at 1,001 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`1.75` at 1,401 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`1.9` at 2,001 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`2.05` at 2,801 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`2.2` at 4,001 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`2.35` at 5,501 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`2.5` at 7,001 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`2.65` at 9,001 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`2.8` at 11,001 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`2.95` at 13,501 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`3.1` at 16,001 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`3.25` at 19,001 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`3.4` at 22,501 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`3.55` at 27,001 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`3.7` at 32,501 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`3.85` at 40,001 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`4.0` at 50,001 {emojis.STAT_COOLNESS}\n'
    )
    note = (
