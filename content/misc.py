...
async def embed_coolness_overview() -> discord.Embed:
    ...
    pet_slots = (
        f'{emojis.BP} x`1.15` at 10 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`1.3` at 100 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`1.45` at 350 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`1.6` at 1,000 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`1.75` at 1,400 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`1.9` at 2,000 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`2.05` at 2,800 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`2.2` at 4,000 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`2.35` at 5,500 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`2.5` at 7,000 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`2.65` at 9,000 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`2.8` at 11,000 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`2.95` at 13,500 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`3.1` at 16,000 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`3.25` at 19,000 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`3.4` at 22,500 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`3.55` at 27,000 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`3.7` at 32,500 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`3.85` at 40,000 {emojis.STAT_COOLNESS}\n'
        f'{emojis.BP} x`4.0` at 50,000 {emojis.STAT_COOLNESS}\n'
    )
    note = (
