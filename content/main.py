...
async def embed_help_guides() -> discord.Embed:
    """Main menu embed"""
    seasonal_event = (
        f'{emojis.BP} {strings.SLASH_COMMANDS_GUIDE["easter guide"]}\n'
    )
    guides = (
    ...
    embed.add_field(name=f'EASTER GUIDE {emojis.EASTER_EGG}', value=seasonal_event, inline=False)
