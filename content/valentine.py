...
async def embed_valentine_guide() -> discord.Embed:
    ...
    activities = (
        ...
        f'{emojis.BP} Kill the rare {emojis.MOB_PINK_WOLF} pink wolf in {strings.SLASH_COMMANDS_EPIC_RPG["hunt"]} to get extra coins\n'
    ...
    schedule = (
        f'{emojis.BP} Event started on February 12, 2023\n'
