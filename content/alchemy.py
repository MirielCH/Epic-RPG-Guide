...
async def embed_alchemy_overview() -> discord.Embed:
    ...
    overview = (
        ...
        f'{emojis.BP} Use {strings.SLASH_COMMANDS_EPIC_RPG["alchemy"]} to brew potions.\n'
        ...
        f'{emojis.BP} If you rebrew the **same** potion, it will **not** stack but reset its time\n'
...
async def embed_alchemy_recommended_potions() -> discord.Embed:
    ...
    good_potions_tt3 = (
        f'{emojis.BP} {emojis.POTION_DRAGON_BREATH} `Cookie potion`\n'
...
async def embed_alchemy_advanced() -> discord.Embed:
    ...
    potion_electronical = (
        ...
        f'{emojis.DETAIL} Become the meme lord everyone aspires to be?\n'
    )
    potion_lootbox = (
        f'{emojis.BP} **Boosts**\n'
        f'{emojis.DETAIL} +`30`% lootbox drop chance in {strings.SLASH_COMMANDS_EPIC_RPG["hunt"]} '
        f'and {strings.SLASH_COMMANDS_EPIC_RPG["adventure"]}\n'
